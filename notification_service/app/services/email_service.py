...
class EmailService:
    ...
    def _send_with_sendgrid(self, to: str, subject: str, html_content: str, text_content: Optional[str] = None) -> bool:
    ...
    def _send_with_smtp(self, to: str, subject: str, html_content: str, text_content: Optional[str] = None) -> bool:
